...
Bar.create!(name: "Corner Cafe",
            ...
            state: "Massachusetts",
            zip: "02113",
            description: "Late-night neighborhood hangout offering booze, casual
             grub & sports TVs in a down-to-earth setting.",
            url: "None",
...
Review.create!(title: "Fix the basketball hoop!",
               rating: 3,
               body: "SO bro-y and SO fun. Cash only. Don't try to order red wine
               otherwise people will make fun of you. They have the basketball
               arcade game in the back, but one of the hoops is always broken
               which is aggravating - taking off a star for that.
                (Please fix it!!)",
               user_id: 1,
               bar_id: 1
)
...
Review.create!(title: "Get the gin gin!",
               rating: 4,
               body: "The space is pretty cool. It's fairly dark inside with some
                graphics on the walls, industrial-sleek furnishings and a
...
Review.create!(title: "Neat-o",
               rating: 3,
               body: "Being from Canada, I don't know why we tried this place, as
                the cold and frost are not novelties to us LOL... nonetheless it
...
Review.create!(title: "Delicioso!",
                rating: 1,
                body: "We 'stumbled' upon this place seeing that getting into toro
                 or barcelona wine bar was near impossible.\n
                 A wee bit out of the way, at least I thought so BUT well worth
                 the visit. The place isn't overcrowded - food, drinks and service
                 are great. You are not rushed, portions are generous and the
                 wait staff are most helpful with suggestions. So A-plus for this
                 find and well worth a return trip.\n
