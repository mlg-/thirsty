...
Bar.create!(name: "Beacon Hill Pub",
            ...
            131684050683",
            photo_url: image_tag("beacon_hill_pub.jpg"),
...
Bar.create!(name: "21st Amendment",
            ...
            photo_url: image_tag("21amendment.jpg"),
            seating_capacity: 96,
            food: true,
            outdoor_seating: false,
            pet_friendly: false
...
Bar.create!(name: "The Hill Tavern",
            ...
            photo_url: image_tag("hill_tavern.jpg"),
            seating_capacity: 150,
            food: true,
...
Bar.create!(name: "Estragon",
            ...
            photo_url: image_tag("estragon.jpg"),
...
Bar.create!(name: "Corner Cafe",
            ...
            url: "None",
            photo_url: image_tag("corner_cafe.jpg"),
            seating_capacity: 32,
            food: false,
            outdoor_seating: false,
            pet_friendly: false
...
Bar.create!(name: "75 Chestnut",
            ...
            photo_url: image_tag("75_chestnut.jpg"),
            seating_capacity: 85,
            food: true,
            outdoor_seating: false,
            pet_friendly: false
...
Bar.create!(name: "JJ Foley's Bar & Grille",
            ...
            photo_url: image_tag("jj_foleys.jpg"),
...
Bar.create!(name: "Scampo",
            ...
            photo_url: image_tag("Scampo.jpg"),
